    ...
    <div className="min-h-screen bg-neutral-50 flex items-center justify-center p-4">
      <div className="max-w-6xl w-full bg-white rounded-3xl shadow-2xl overflow-hidden grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="p-8 lg:p-16 flex flex-col justify-center">
          ...
          <button
            type="button"
            className="w-full bg-white border border-neutral-200 text-neutral-700 hover:bg-neutral-50 font-bold py-3 px-4 rounded-xl flex items-center justify-center gap-3 transition-all mb-6"
            onClick={() => alert("Google Login non implémenté. Veuillez utiliser l'onglet email/mot de passe.")}
          >
